...
def get_file_info(file_path: str) -> dict[str, Any]:
    ...
    try:
        ...
        return {"size": stat.st_size, "modified_time": int(stat.st_mtime), "checksum": calculate_checksum(file_path)}
    except Exception as e:
        logger.error(f"Error getting file info for {file_path}: {e}")
        return {"size": 0, "modified_time": 0, "checksum": None}
...
def get_relative_path(base_path: str, full_path: str) -> str | None:
    """
